...
const handleBurnTokens = () => {
  ...
  toast.success(`Successfully burned ${burnAmount} tokens, reducing carbon emissions by ${parseFloat(burnAmount) * 0.05} kg`);
                    ...
                    <tbody className="bg-white divide-y divide-gray-200">
                      {[...mockTokenHistory, ...mockBurnHistory.map(burn => ({
                        ...
                        <tr key={idx}>
                          ...
                          <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                            {transaction.type === 'burned' ? `${transaction.carbonReduction} kg` : '-'}
                          </td>
            ...
            <div className="inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full sm:p-6">
              <div>
                ...
                <div className="mt-3 text-center sm:mt-5">
                  ...
                  <div className="mt-2">
                    <p className="text-sm text-gray-500">
                      For every token burned, approximately 0.05 kg of carbon emissions will be reduced.
                    </p>
                  </div>
                </div>
                <div className="mt-5">
                  ...
                  {burnAmount && (
                    <p className="mt-2 text-sm text-green-600">
                      Estimated carbon reduction: {parseFloat(burnAmount) * 0.05} kg
                    </p>
                  )}
                </div>
              </div>
            ...
            <div className="inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full sm:p-6">
              <div>
                ...
                <div className="mt-3 text-center sm:mt-5">
                  ...
                  <div className="mt-2">
                    <p className="text-sm text-gray-500">
                      By burning your LGR tokens, you are contributing to real-world carbon reduction projects. Each token equals approximately 0.05 kg of carbon emissions reduction.
                    </p>
                  </div>
                </div>
              </div>
